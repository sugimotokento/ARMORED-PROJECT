...
public:
	...
	static XMFLOAT4 QuaternionRotateAxis(const XMFLOAT4& quat, const XMFLOAT3& axis, float angle);
	static XMFLOAT4 QuaternionSetRotation(const XMFLOAT3& axis, float angle);
	static XMFLOAT4 QuaternionNormalize(const XMFLOAT4& quat);
};
